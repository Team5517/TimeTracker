...
*/
	...
	*/ 
	...
	$config['database']['user_acc']['join'] = 'user_accounts.id';
	$config['database']['user_acc']['columns']['id'] = 'id';
	$config['database']['user_acc']['columns']['group_id'] = 'group_id';
	...
	*/ 
	$config['database']['settings']['search_user_cols'] = array('username');
	...
	*/
	$config['sessions']['user_identifier'] = 'user_identity';
	...
	*/
	 ...
	 * . = all characters
	*/ 
	$config['security']['valid_password_chars'] = '.';
	...
	*/
	$config['security']['static_salt'] = ':Jbzaz74XD0br-z*`]v+XEQfYKlY8:!=V8>+*E[s79K,u)^tH1&kL)nuIsjKB;mb';
